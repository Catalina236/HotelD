    ...
    <div class="contenido">
        <section class="serviciosl">
            ...
            <div class="serviciosa 1">
                <img src="../admin/clases/Servicios/imagenes/<?php echo $servicios['foto_serv'];?>" alt="">
                <div class="info">
                    <h3><?php echo $servicios['nom_producto_bar'];?> </h3>
                ...
                <form class="formulario" method="POST" action="serviciobar.php">
                    ...
                    <input type="hidden" name="id_bar" value="<?php echo $servicios['id_bar']; ?>">
